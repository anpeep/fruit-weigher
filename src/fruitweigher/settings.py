"""
Django settings for fruitweigher project.
...
ACCOUNT_FORMS = {
    'signup': 'useraccounts.forms.CustomSignupForm',  # Update with correct app name
}
INSTALLED_APPS = [
    'products',
    'useraccounts',
    ...
    'allauth.account',  # Email and username login
]
